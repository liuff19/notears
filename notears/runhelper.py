...
def config_parser():
    ...
    parser.add_argument('--d', type=int, default=11, help='number of nodes')
    parser.add_argument('--s0', type=int, default=17, help='number of edges')
    ...
    parser.add_argument('--n', type=int, default=853, help='number of samples')
