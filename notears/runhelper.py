...
def config_parser():
    ...
    parser.add_argument("--data_type", default='real', type=str, help = 'real or synthetic')
    ...
    parser.add_argument("--adaptive_epoch", default=1000, type=int, help="number of iterations for adaptive reweight")
